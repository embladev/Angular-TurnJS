angular.module('appMain', ['angularTurn'])
    ...
    .factory('reportService', function() {
        ...
        var index = -1 ;
        var dataSet = [
            { "title" : "Ronaldinho", "img": "img/ronaldino.jpg", "description" : "Ronaldo de Assis Moreira (born 21 March 1980), commonly known as Ronaldinho, is a Brazilian professional footballer and current club ambassador for Spanish club FC" },
            { "title" : "Kumar Sangakkara", "img": "img/sanga.jpg", "description" : "Kumar Sanga Chokshanada Sangakkara is a former Sri Lankan cricketer and captain of the Sri Lankan national team. Widely regarded as one of the world's most influential cricketers,Sangakkara rated as the second greatest ODI batsman of all time in a recent public  poll." }
            ];
